...
class resultset extends \injector implements resultsetInterface
{
	...
	public function current()
	{
		if(!isset($this->_record[$this->_positon])) {
			$this->_record[$this->_positon] = static::$locator->make('record', [$this->_data[$this->_positon], $this->_query]);
		}
	...
	public function offsetGet($offset)
	{
		...
		if(!isset($this->_record[$offset])) {
			$this->_record[$offset] = static::$locator->make('record', [$this->_data[$offset], $this->_query]);
		}
